<template>
  <div class="cultivation-todo-list">
        ...
        <v-card-text class="pa-4">
          <div class="d-flex align-center">
            ...
            <div class="ml-3 flex-grow-1">
              <div class="d-flex flex-wrap align-center" :class="{
              ...
              <div class="text-body-2 text-medium-emphasis mt-1" v-if="todo.description">
                {{ todo.description }}
              </div>
            ...
            <div class="reward-info">
              ...
              <div class="text-caption text-center mt-1">
                <v-icon icon="mdi-lightning-bolt" size="x-small" class="mr-1 text-deep-orange"></v-icon>
          ...
          <v-expand-transition>
            <div v-if="todo.status === 'done' && todo.reward_info?.is_rewarded" class="reward-received mt-3">
              <v-divider class="mb-2"></v-divider>
              <div class="d-flex align-center text-success">
                <v-icon icon="mdi-check-decagram" color="success" class="mr-1"></v-icon>
    ...
    >
      ...
      <div>没有{{ activeFilter === 'pending' ? '待完成' : '已完成' }}的任务</div>
    </div>
  </div>
</template>
...
// 事件
const emit = defineEmits(['complete-todo', 'reopen-todo', 'refresh', 'add-todo'])
